...
<!DOCTYPE html>
  ...
  <div class="row result">
    <div class="col s6">
      <div class="card z-depth-1 layout">
            <div class="card-content white-text text">
              
              <span class="card-title pad">Play Now</span>

              
              <p class="pad">Play games like 'Scatter' to check your memory and response in this race against time. But first, select a set to play.</p>
              <img class="size" src="image/gaming.png" />
            </div>
          </div>
    </div>
    <div class="col s6">
          ...
          <div class="card card-size z-depth-1 center-align">
                <div class="card-content waves-effect waves-block waves-light white-text">
                  ...
                  ><?php echo '<a href="game.php?id=' . $row['set_name'] . '">' . $row['set_name'] . '</a>'; ?>  
                </div>
