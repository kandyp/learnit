...
$query="SELECT * FROM `spanish` LIMIT $page1,20";
...
for($b=1;$b<=$u;$b++){
  ?><li class="waves-effect"><a class="text styling" href="spanish.php?page=<?php echo $b." "  ; ?>"><?php echo $b;?></a></li><?php
}
